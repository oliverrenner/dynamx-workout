...
export const EQUIPMENT: { id: EquipmentId; label: string; short: string }[] = [
  ...
  { id: 'exercise-ball', label: 'Exercise ball', short: 'Ball' },
  { id: 'cable-machine', label: 'Cable machine', short: 'Cable' },
];
...
export const EXERCISES: Exercise[] = [
  ...
  { id: 'push-up', name: 'Push-up', movement: 'push', equipment: [], targets: levelTargets('8 reps', '12 reps', '15 reps', '18 reps', '20 reps') },
  ...
  { id: 'shoulder-tap', name: 'Plank shoulder tap', movement: 'core', equipment: [], targets: levelTargets('10 sec', '15 sec', '20 sec', '30 sec', '40 sec') },
  ...
  { id: 'criss-cross', name: 'Criss cross', movement: 'core', equipment: [], targets: levelTargets('10 reps', '15 reps', '20 reps', '25 reps', '30 reps') },
  { id: 'crunch', name: 'Crunch', movement: 'core', equipment: [], targets: levelTargets('10 reps', '15 reps', '20 reps', '25 reps', '30 reps') },
  { id: 'leg-raise', name: 'Leg raise', movement: 'core', equipment: [], targets: levelTargets('10 reps', '15 reps', '20 reps', '25 reps', '30 reps') },
  { id: 'bird-dog-crunch', name: 'Bird-dog crunch', movement: 'core', equipment: [], targets: levelTargets('10 total', '15 total', '20 total', '25 total', '30 total') },
  { id: 'bicycle-crunch', name: 'Bicycle crunch', movement: 'core', equipment: [], targets: levelTargets('10 sec', '15 sec', '20 sec', '30 sec', '40 sec') },
  { id: 'plank-rock', name: 'Plank rock', movement: 'core', equipment: [], targets: levelTargets('10 reps', '15 reps', '20 reps', '25 reps', '30 reps') },
  { id: 'plank-up-down', name: 'Plank up-down', movement: 'core', equipment: [], targets: levelTargets('4 / side', '6 / side', '10 / side', '12 / side', '15 / side') },
  { id: 'side-plank-rotation', name: 'Side-plank rotation', movement: 'core', equipment: [], targets: levelTargets('6 / side', '10 / side', '15 / side', '20 / side', '25 / side') },
  { id: 'straight-jump', name: 'Straight jump', movement: 'cardio', equipment: [], targets: levelTargets('6 reps', '9 reps', '12 reps', '15 reps', '18 reps') },
  { id: 'lateral-jump', name: 'Lateral jump', movement: 'cardio', equipment: [], targets: levelTargets('4 / side', '6 / side', '8 / side', '10 / side', '12 / side') },
  ...
  { id: 'bulgarian-split-squat', name: 'Bulgarian split squat', movement: 'lunge', equipment: ['bench-box'], targets: levelTargets('8 / side', '12 / side', '15 / side', '18 / side', '20 / side') },
  ...
  { id: 'ball-glute-bridge', name: 'Ball glute bridge', movement: 'hinge', equipment: ['exercise-ball'], targets: levelTargets('10 reps', '15 reps', '20 reps', '25 reps', '30 reps') },
  { id: 'lat-pulldown-hold', name: 'Lat pulldown with hold', movement: 'pull', equipment: ['cable-machine'], targets: levelTargets('8 reps', '12 reps', '15 reps', '18 reps', '20 reps') },
  { id: 'lat-pulldown-leg-extension', name: 'Lat pulldown with leg extension', movement: 'pull', equipment: ['cable-machine'], targets: levelTargets('3 / side', '4 / side', '5 / side', '6 / side', '8 / side') },
];
