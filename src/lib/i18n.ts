...
export const COPY: Record<Language, Copy> = {
  en: {
    ...
    levels: { level1: 'Level 1', level2: 'Level 2', level3: 'Level 3', level4: 'Level 4', level5: 'Level 5' },
  ...
  de: {
    ...
    levels: { level1: 'Stufe 1', level2: 'Stufe 2', level3: 'Stufe 3', level4: 'Stufe 4', level5: 'Stufe 5' },
